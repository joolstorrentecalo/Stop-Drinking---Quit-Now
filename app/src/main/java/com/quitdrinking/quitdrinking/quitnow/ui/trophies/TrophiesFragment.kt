...
class TrophiesFragment : Fragment() {
    ...
    private fun createTrophyItems(): List<Trophy> {
        ...
        allItems.add(Trophy.Data(R.drawable.life_regained_3, regainedDays >= 3))
        allItems.add(Trophy.Data(R.drawable.life_regained_5, regainedDays >= 5))
        allItems.add(Trophy.Data(R.drawable.life_regained_7, regainedDays >= 7))
        allItems.add(Trophy.Data(R.drawable.life_regained_10, regainedDays >= 10))
        allItems.add(Trophy.Data(R.drawable.life_regained_14, regainedDays >= 14))
        ...
        allItems.add(Trophy.Data(R.drawable.life_regained_1000, regainedDays >= 1000))
        allItems.add(Trophy.Data(R.drawable.life_regained_3650, regainedDays >= 3650))
